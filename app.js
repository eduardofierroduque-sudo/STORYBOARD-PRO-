                    ...
                    for (var p = 0; p < escena.planos.length; p++) {
                        (function(p) {
                            pChain = pChain.then(function() {
                                ...
                                var uniquePrompt = 'Scene ' + (e + 1) + ' Shot ' + (p + 1) + '. ' + escena.planos[p].image_prompt;
